...
<table border="1" align="right">
    <tr style="background-color:#E1E1E1;font-weight: bold; ">
        ...
        <th align="center" width="120px">Maquina</th>
        <th align="center" width="110px">Serial</th>
        <th align="center" width="100px">Modelo</th>
        <th align="center" width="100px">Marca</th>
        <th align="center" width="60px">Año</th>
        <th align="center" width="100px">Propietario</th>
...
$html = $html.'
    <tr style="background-color:'.$color.'">
        ...
        <td align="center">'.$maquinaria['TiposMaquinaria']['nombre'].'</td>
        <td align="center">'.$maquinaria['Maquinaria']['serial'].'</td>
        <td align="center">'.$maquinaria['Maquinaria']['modelo'].'</td>
        <td align="center">'.$maquinaria['Maquinaria']['marca'].'</td>
        <td align="center">'.$maquinaria['Maquinaria']['anio'].'</td>
        <td align="center">'.$maquinaria['Maquinaria']['propietario'].'</td>        
    </tr>
';
$i++;
}
