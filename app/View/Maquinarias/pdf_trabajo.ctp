...
$distancia = strtoupper($post['CamionesTrabajo']['distancia']);*/
$maquina = $trabajos['Maquinaria']['info'];
$fecha = date('d/m/Y');
$hora = date('g:i  A');
$dias = date('d');
//$mes = $meses[date('m')];
...
<h2>Datos de la Maquina</h2>
<p>$maquina&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Fecha del Reporte: $fecha</p>
<h4 style="text-align:center;">Trabajo Realizado por la Maquina</h4>
    ...
    <tr style="background-color:#E1E1E1;font-weight: bold;margin-left: 100px; ">
        ...
        <th style="width:25%; text-align:center;">Hora o Mts3</th>        
...
$html = $html.'
    <tr style="background-color:'.$color.'">
        ...
        <td align="center">'.$trabajo['Tabulador']['unidad'] .' - '.$trabajo['Tabulador']['costo'].'</td>
        <td align="center">'.$trabajo['cantidad'].'</td>
        <td align="center">'.number_format($trabajo['costo'],2,',','.').'</td>
