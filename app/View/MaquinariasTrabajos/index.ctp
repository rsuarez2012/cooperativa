        ...
        <div class="wTitle">
         <h5><?php echo strtoupper(Inflector::humanize(Inflector::underscore($this->params['controller']))); ?></h5>
          <ul class="nav nav-tabs pull-right" id="dashboard-demo">
            ...
            <li><a href="<?php echo '../maquinariasTrabajos/reporte';?>"><i class="icon icon-print"></i></a></li>
          </ul>
        </div>
          ...
          <table cellpading="0" cellspacing="0" border="0" class="dTable" id="tab">
            ...
            <tbody align="center">
              ...
              <?php foreach($trabajos as $trabajo) {  ?>
                 <tr>
                    <td class="checkboxes"><input type="checkbox" name="checkbox" id="row" value="<?php echo $trabajo['MaquinariasTrabajo']['id']; ?>"></td>
                    <td><?php echo $this->Time->format($trabajo['MaquinariasTrabajo']['fecha'], '%d-%m-%Y'); ?></td>
                    <td><?php echo $trabajo['Maquinaria']['info']; ?></td>
                    <td><?php echo $trabajo['MaquinariasTrabajo']['costo']; ?></td>
                 </tr>
              <?php } ?>                       
              </tr>                      
            </tbody>
