      ...
      <div class="widget">
        <div class="wTitle">
          ...
          <ul class="nav nav-tabs pull-right" id="dashboard-demo">
            ...
            <li><a href="<?php echo '../empleados/listaEmpleados';?>"><i class="icon icon-print"></i></a></li>
          </ul>
        </div>
          ...
          <table cellpading="0" cellspacing="0" border="0" class="dTable">
            ...
            <tbody align="center">
              ...
              <?php foreach($empleados as $empleado) { ?>
                 <tr>
                    <td class="checkboxes"><input type="checkbox" name="checkbox" id="row" value="<?php echo $empleado['Empleado']['id']; ?>"></td>
                    <td><?php echo $empleado['Empleado']['cedula']; ?></td>
                    <td><?php echo $empleado['Empleado']['apellidos']; ?></td>
                    <td><?php echo $empleado['Empleado']['nombres']; ?></td>
                    <td><?php echo $empleado['Empleado']['telefono']; ?></td>
                    <td><?php echo $empleado['Empleado']['correo']; ?></td>
                    <td><?php echo $empleado['Cargo']['nombre_cargo']; ?></td>
                 </tr>
              <?php } ?>                       
              </tr>                      
            </tbody>
